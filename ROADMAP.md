...
- [ ] Arrow keys to nudge/resize the selection, Shift to lock aspect ratio
- [ ] Crosshair guide lines across the screen
- [ ] Self-timer (3/5/10 s)
- [ ] Hide desktop icons during capture
- [ ] Optionally include the cursor
- [ ] Swipe to dismiss Quick Access, close after drag and drop
- [ ] Multi-display selection spanning screens
- [ ] App icon
...
## M6: History and semantic search
